...
{
    [LocalizedDisplayName(nameof(Resources.SendCarousel_DisplayName))]
    [LocalizedDescription(nameof(Resources.SendCarousel_Description))]
    public class SendCarousel : ContinuableAsyncCodeActivity
    {
        #region Properties
        ...
        [LocalizedDisplayName(nameof(Resources.SendCarousel_Carousel_DisplayName))]
        [LocalizedDescription(nameof(Resources.SendCarousel_Carousel_Description))]
        [LocalizedCategory(nameof(Resources.Input_Category))]
        [RequiredArgument]
        public InArgument<CarouselData> Carousel { get; set; }
        ...
        protected override void CacheMetadata(CodeActivityMetadata metadata)
        {
            ...
            if (Carousel == null) metadata.AddValidationError(string.Format(Resources.ValidationValue_Error, nameof(Carousel)));
        ...
        private async Task ExecuteWithTimeout(AsyncCodeActivityContext context, CancellationToken cancellationToken = default)
        {
            ...
            var carousel = Carousel.Get(context);
            ///////////////////////////
            // Add execution logic HERE
            ///////////////////////////
            ///
            var rply = new CarouselReply();
            rply.scenario_id = scenarioid;
            rply.session_id = sessionid;
            rply.messages.Add(new CarouselMessage(carousel));
